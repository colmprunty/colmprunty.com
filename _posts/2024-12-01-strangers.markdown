...
date:   2024-12-01 21:07:35 +0000
categories: movies
---

Newly armed with a Criterion Channel subscription for the year, it's back to the Hitchcock mines. I've seen most of the big hits (including _Notorious_ twice without realising until a bit into the second time) but the guy made a lot of movies. _Strangers on a Train_ has a killer premise, what if two people had a murder they wanted done, with no connection to each other, and they decided to swap murders to leave behind no connection and no motive. The only risk really is that one of the people doesn't actually want to do it, and the other is such a remorseless psycho that he basically does it same day.
